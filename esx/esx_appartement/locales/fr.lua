Locales['fr'] = {
  ...
  ['owned_appartement'] = 'propriétés acquises',
  ['available_appartement'] = 'propriétés disponibles',
  ...
  ['keys_config'] = 'Trousseau de clées',
  ['dring_on'] = 'Activer la sonette',
  ['break_door'] = 'Enfoncer la porte',
