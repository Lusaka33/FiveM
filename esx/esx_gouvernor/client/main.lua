  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'menu_vault' and in_service then
            OpenVaultMenu()
        end

        if CurrentAction == 'menu_fridge' and in_service then
            OpenFridgeMenu()
        end

        if CurrentAction == 'menu_shop' and in_service then
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() and in_service then
