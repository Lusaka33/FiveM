...
local WeedPNJ = {
	{id=1, Name=PnjWeed, VoiceName="GENERIC_INSULT_HIGH", Ambiance="AMMUCITY", Weapon=1649403952, modelHash="A_F_Y_Hippie_01", x = 2217.7956542969, y = 5578.30859375, z = 53.720989227295, heading=196.11868286133},
}
...
function OpenMenuWeed()
  ...
  local elements = {
    {label = 'Acheter des graines de weed',  value = 'seedweed'},
